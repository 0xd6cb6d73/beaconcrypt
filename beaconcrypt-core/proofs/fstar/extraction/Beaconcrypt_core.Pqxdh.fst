...
let v_SYM_RATCHET_INFO: t_Array u8 (mk_usize 41) = Beaconcrypt_core.Ratchet.v_SYM_RATCHET_INFO
...
type t_InitialRatchetChains = {
  ...
  f_receive_chain:Beaconcrypt_core.Ratchet.t_RatchetChain
}

let impl_InitialRatchetChains__into_parts (self: t_InitialRatchetChains)
    : (Beaconcrypt_core.Ratchet.t_RatchetChain & Beaconcrypt_core.Ratchet.t_RatchetChain) =
...
let split_initial_ratchet_kdf_output
  ...
  then
    {
      f_send_chain = Beaconcrypt_core.Ratchet.impl_RatchetChain__from_bytes left;
      f_receive_chain = Beaconcrypt_core.Ratchet.impl_RatchetChain__from_bytes right
    }
    <:
    t_InitialRatchetChains
  else
    {
      f_send_chain = Beaconcrypt_core.Ratchet.impl_RatchetChain__from_bytes right;
      f_receive_chain = Beaconcrypt_core.Ratchet.impl_RatchetChain__from_bytes left
    }
    <:
    t_InitialRatchetChains
