...
The `State` field returned by state-update methods contain secret material. Do not log them. Persist state securely and atomically, and do not clone or roll back a state snapshot.
