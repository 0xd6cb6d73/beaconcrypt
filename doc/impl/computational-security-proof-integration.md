...
The [SSProve end-to-end composition investigation](ssprove-end-to-end-composition.md) turns that gap into a concrete architecture: PQXDH becomes a keying package, the ratchet and record transform become a keyed package, and a private session-indexed key interface connects their disjoint states. It specifies the four-corner state-separating hybrid, a single prefix-consistent HKDF package with the exact labels above, the required collision events, public and private protocol interfaces, deterministic representation bridges, and phased acceptance criteria. It is a design and proof plan, not a claimed composition theorem.
