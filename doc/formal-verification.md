...
- One canonical 126-fact production transcript interface consumed by every scenario and checked against compiled core builders, mutable covered adapter/commitment/schema sources, the exact Phase-1, Phase-2, and `CryptoFrame` schema ordinals and mappings, and its ProVerif declaration, process, active-quantum witness, and ideal frame-constructor sites.
