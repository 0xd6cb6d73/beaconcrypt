...
This component theorem justifies the confidentiality half of ProVerif's ideal `seal_frame`/`open_frame` abstraction under the modeled nonce-AEAD IND$ and classical-ROM assumptions. It does not prove privacy for concrete BLAKE2b or ChaCha20-Poly1305, normalize raw wire values, connect Rust and adapters, compose ratchet/HKDF or multiple keys, handle the QROM, formalize PPT cost, or mechanically convert the complete ProVerif result into an end-to-end computational theorem.
