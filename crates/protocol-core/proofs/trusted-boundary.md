...
- two generated F* modules and two strictly checked handwritten F* lemma
  modules;
- one generated ProVerif library, exactly three production-backed replacement fragments, nine handwritten ProVerif model/query libraries, and four top-level process files;
