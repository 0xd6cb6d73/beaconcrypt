...
ProVerif establishes these results only in the stated ideal symbolic model. It does not establish concrete HKDF or ML-KEM security, derive ML-KEM public-key binding from IND-CCA, synchronize symbolic constructor names with Rust byte strings, prove implementation fidelity, or provide computational security for the protocol or primitives.
