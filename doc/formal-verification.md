...
- One canonical 84-fact production transcript interface consumed by every scenario and checked against compiled core builders, the exact Phase-1 and Phase-2 schema ordinals and adapter mappings, and its ProVerif declaration, process, and active-quantum witness sites.
