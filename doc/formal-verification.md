...
SSProve machine-checks a bounded hidden-ROM CTX verifier, collision extractor, `q + 2` trace bound, and separate true-real/fresh-ideal privacy hop. Completing the production-width representation bridge, numerical collision and hidden-query bounds, primitive instantiation, and runtime accounting remains conventional.
